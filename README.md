...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-inverse-by/tags). For example,

```javascript
invertBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-inverse-by@v0.1.1-umd/browser.js' )
```
...
[@stdlib/object/inverse]: https://github.com/stdlib-js/object-inverse/tree/umd
